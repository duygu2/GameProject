...
public class LPNKPSPublicSoap
{
    ...
    public LPNKPSPublicSoap(){}

    public LPNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public LPNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        LPNExtendedSoapSerializationEnvelope envelope= new LPNExtendedSoapSerializationEnvelope(LPNExtendedSoapSerializationEnvelope.VER11);
