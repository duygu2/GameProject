...
public class LPNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(LPNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new LPNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static LPNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static LPNDateTimeConverter dateTimeConverter = new LPNStandardDateTimeConverter();

    public LPNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public LPNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new LPNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=LPNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,LPNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=LPNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
